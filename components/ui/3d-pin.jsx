    ...
    (<a
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  bg-secondary-foreground  border border-[rgba(255,255,255,0.10)]  shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group  group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
...
export const PinPerspective = ({
  ...
  return (
    (<motion.div
      className="pointer-events-none w-68 sm:w-80 h-84 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
