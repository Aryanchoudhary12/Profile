  ...
  return (
    <div className="mt-6" id="About">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start p-4 gap-6 mt-6">
        <Image src={avatar} alt="Avatar" className="col-span-1 w-60 h-60 " priority/>
        <div className="col-span-1">
          <p className="text-base font-roboto font-semibold text-center md:text-left w-5/6">
            ...
            studing in IIIT Ranchi , pursuing Bachelor of Technology in Computer
            and Engineering .
          </p>
          <div className="grid grid-cols-6  gap-2 mt-2">
            <p className="font-roboto font-bold col-span-1">HTML</p>
            <hr className="border-3 w-full rounded-2xl border-primary col-span-5 mt-2"/>
          </div>
          <div className="grid grid-cols-6  gap-2 mt-2">
      ...
      <h1 className="text-4xl font-bold font-rubik text-center mt-6">What I Do ?</h1>
      ...
      <h1 className="text-4xl font-bold font-rubik text-center mt-6">Tech Stack</h1>
      <div className="grid grid-cols-3 md:grid-cols-4 xl:grid-cols-5 gap-4 p-4">
        {techStack.map((stack,index)=>{
          return (
            <div key={stack.title} className="flex flex-col items-center gap-2  border-2 border-secondary/20 rounded-md p-2 py-4 bg-secondary-foreground">
              <p className="w-full text-base font-bold text-muted-foreground text-left">{index + 1}.</p>
              <Image src={stack.image} alt={stack.title} className="h-12 w-12 object-cover" />
