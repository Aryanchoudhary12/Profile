    ...
    <div>
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 p-4 mt-10 h-fit">
        <div className="flex flex-col justify-center items-center lg:items-start lg:ml-4">
          <p className="text-xl font-bold  ml-2 font-roboto">Hello, I'm </p>
          <p className="text-7xl font-extrabold text-center lg:text-left">
            ARYAN <br />
            <span className="text-secondary font-rubik">CHOUDHARY</span>
          </p>
          ...
          <div className="flex gap-2">
            <Link href="#Contact">
              <button className=" bg-button p-2 px-3 rounded-md text-lg font-semibold font-roboto mt-6">
                Contact Me
              </button>
            </Link>
            <Link href="/resume.pdf" target="_blank">
              <button className="border-2 border-button p-2 px-3 rounded-md text-lg font-semibold font-roboto mt-6">
                Download Resume
              </button>
            </Link>
          </div>
